...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    -- launch dmenu
    , ((modm,               xK_p     ), spawn "dmenu_run -fn 'Liberation Mono:pixelsize=25'")

    -- display brightness
    , ((modm,               xK_Up     ), spawn "bash -c /home/moritz/scripts/brightness_up")

--    , ((modm,               xK_Up     ), spawn "echo $UID > /home/moritz/user.txt")

    , ((modm,               xK_Down     ), spawn "bash -c /home/moritz/scripts/brightness_down")
